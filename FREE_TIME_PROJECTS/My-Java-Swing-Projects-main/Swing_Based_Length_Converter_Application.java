...
public class JavaApplication1 {
    ...
    public static void main(String[] args) 
    {
        ...
        JLabel appTitle = new JLabel("LENGTH CONVERTER APP");
        ...
        fromComboBox.addItem("meter");
        fromComboBox.addItem("centimeter");
        fromComboBox.addItem("decimeter");
        fromComboBox.addItem("milimeter");
       
        fromComboBox.setBounds(100,100,150,50);
        
        JComboBox toComboBox = new JComboBox();
        toComboBox.addItem("kilometer");
        toComboBox.addItem("meter");
        toComboBox.addItem("centimeter");
        toComboBox.addItem("decimeter");
        toComboBox.addItem("milimeter");
